...
INSERT INTO `film` (`film_id`, `film_title`, `film_director`, `film_genre`, `film_synopsis`, `film_duration`, `film_release_date`, `film_status`, `film_poster`) VALUES
                                                                                                                                                                     (1, 'Le voyage de Chihiro', 'Hayao Miyazaki', 'Fantasy', 'Au cours d\'un voyage en voiture, la famille de Chihiro,10 ans, fait une halte dans un parc à thème qui semble abandonné. Ses parents découvrent des mets succulents dans un restaurant et commencent à manger. Ils se retrouvent alors transformés en cochons. Prise de panique, Chihiro s\'enfuit et rencontre l\'énigmatique Haku, qui lui explique le fonctionnement de l\'univers dans lequel elle vient de pénétrer. Pour sauver ses parents, la fillette va devoir faire face à la terrible sorcière Yubaba.', 125, '2002-04-14', 0, 'a venir'),
                                                                                                                                                                     (2, 'Dune: Deuxième partie', 'Denis Villeneuve', 'SF', 'Paul Atréides se rallie à Chani et aux Fremen tout en préparant sa revanche contre ceux qui ont détruit sa famille. Alors qu\'il doit faire un choix entre l\'amour de sa vie et le destin de la galaxie, il devra néanmoins tout faire pour empêcher un terrible futur que lui seul peut prédire.', 166, '2024-02-28', 0, 'a venir'),
                                                                                                                                                                     (3, 'Joker: Folie à Deux', 'Todd Phillips', 'Crime', 'Arthur Fleck n\'est plus seul. Le voilà entraîné dans une folie à deux. Plus que jamais, le monde est une comédie.', 122, '2024-10-02', 2, 'a venir'),
(4, 'Back to Black', ' Sam Taylor-Johnson', 'Musical', 'Retour sur la vie et la musique d\'Amy Winehouse, à travers la création de l\'un des albums les plus iconiques de la musique contemporaine, inspiré par son histoire d\'amour passionnée et tourmentée avec Blake Fielder-Civil.', 122, '2024-04-24', 1, 'a venir'),
                                                                                                                                                                     (5, 'The Fall Guy', 'David Leitch', 'Action', 'Comme tous les cascadeurs, Colt Seavers se fait tirer dessus, exploser, écraser, jeter par les fenêtres et tombe toujours de plus haut, pour le plus grand plaisir du public. Un an après un accident qui a failli mettre fin à sa carrière, Colt est engagé sur le film de Jody Moreno, son ex-petite amie, pour servir de doublure à Tom Ryder, un célèbre acteur. Quand la star disparaît, Colt se porte volontaire pour le retrouver, espérant sauver le film et reconquérir Jody par la même occasion.', 125, '2024-05-01', 1, 'a venir'),
                                                                                                                                                                     (6, 'Pulp Fiction', 'Quentin Tarantino', 'Crime/Thriller', ' L\'odyssée sanglante et burlesque de petits malfrats dans la jungle de Hollywood à travers trois histoires qui s\'entremêlent.', 154, '1994-10-26', 0, 'a venir'),
                                                                                                                                                                     (7, 'Deadpool & Wolverine', 'Shawn Levy', 'Super-héros', 'Wolverine se remet de ses blessures lorsqu\'il croise le chemin de la grande gueule, Deadpool, qui a voyagé dans le temps pour le soigner dans l\'espoir de devenir amis et de faire équipe pour vaincre un ennemi commun.', 130, '2024-07-24', 2, 'a venir'),
                                                                                                                                                                     (8, 'La Planète des Singes : Le nouveau royaume', 'Wes Ball', 'Action', '300 ans après la mort de César, plusieurs camps de primates vivent dans le havre de paix, tandis que les humains ont régressé à l\'état sauvage à l\'extérieur de leur territoire. Alors que certains clans ont corrompu et dogmatisé l\'enseignement de César, un nouveau chef tente d\'unifier les différents camps grâce à la technologie humaine. En parallèle, Noa, un singe qui a fui l\'esclavage, rencontre une humaine.', 145, '2024-05-22', 2, 'a venir'),
(9, 'Spy × Family Code: White', 'Takashi Katagiri', 'Action/Comédie', 'Après avoir été averti qu\'il serait remplacé dans l\'Opération Strix, Loid décide d\'aider Anya à remporter un concours de cuisine à l\'Eden Academy en préparant le repas préféré du directeur afin d\'empêcher son remplacement. Les Forger décident donc de se rendre dans la région d\'origine du plat, où ils déclenchent une chaîne d\'actions qui pourraient potentiellement mettre en danger la paix dans le monde.', 110, '2024-04-17', 0, 'a venir'),
...
(11, 'Dune', 'Denis Villeneuve', 'SF', 'Paul Atreides, un jeune homme brillant et doué au destin plus grand que lui-même, doit se rendre sur la planète la plus dangereuse de l\'univers afin d\'assurer l\'avenir de sa famille et de son peuple.', 155, '2021-09-15', 0, 'a venir'),
                                                                                                                                                                     (12, 'Une vie', 'James Hawes', 'Guerre', 'À Prague, en 1938, alors que la ville est sur le point de tomber aux mains des nazis, un banquier londonien va tout mettre en oeuvre pour sauver des centaines d\'enfants promis à une mort certaine dans les camps de concentration.', 110, '2024-02-21', 0, 'a venir');
...
INSERT INTO `user` (`user_id`, `user_firstname`, `user_lastname`, `user_mail`, `user_pseudo`, `user_password`, `user_birthday`, `user_role`, `user_type`) VALUES
                                                                                                                                                              (1, 'Lily', 'Wunsch', 'lily.wunsch@edu.ece.fr', 'Leelee', 'password', '2003-11-28', 0, 2),
                                                                                                                                                              (2, 'Paul', 'Fortuna', 'paulalexandre.fortuna@edu.ece.fr', 'paulfrtn', 'password2', '2002-08-17', 0, 2),
                                                                                                                                                              (3, 'JN', 'Neyret', 'jeannicolas.neyret@edu.ece.fr', 'ji3en', 'password3', '2002-04-01', 0, 3),
                                                                                                                                                              (4, 'Jules', 'Puget', 'julespuget@edu.ece.fr', 'soulax', 'password4', '2003-04-01', 0, 1),
                                                                                                                                                              (5, 'admin', 'cinéma', 'admin.cinema@cinecema.fr', 'admin', 'admin', '2000-04-01', 1, 1);
...
--
ALTER TABLE `film`
    MODIFY `film_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
